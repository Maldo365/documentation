...
configured, frequencies can be set, appraisal templates can be edited, evaluation scales can be
managed, data for 360 feedback can be stored, skills can be managed, and goal tags can be created.
