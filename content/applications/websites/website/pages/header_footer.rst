...
.. tip::
   ...
   :guilabel:`THEME` tab of the website editor. Scroll down to the :guilabel:`Advanced` section to
   hide header or to show it again.
...
- Choose a :guilabel:`Slideout Effect` between :guilabel:`Regular`, :guilabel:`Slide Hover` and
  :guilabel:`Shadow` as a :guilabel:`Slideout Effect`.
